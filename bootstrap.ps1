...
#
#   irm https://raw.githubusercontent.com/SEU-USUARIO/SEU-REPO/main/bootstrap.ps1 | iex
#
...
irm "https://raw.githubusercontent.com/SEU-USUARIO/SEU-REPO/main/instaladorprogramas.ps1" | iex
